<template>
    <el-row class="lives-news">
        ...
        <el-col>
            <el-form :inline="true">
                <el-form-item>
                    <a :href="BASEURL+'/admin/rechargeOrder/export?token='+jwt"><el-button type="primary">订单导出</el-button></a>
                </el-form-item>
            </el-form>
        </el-col>
        <el-col>
            <el-table :data="rechargeData">
                <el-table-column prop="rechargeOrderSn" width="220px" label="序列号" align="center"></el-table-column>
                <el-table-column width="100px" prop="money" label="充值金额" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        //获取视频列表
        getLists: function() {
            getRechargeOrder({ params: { pageId: this.pageId, pageSize: this.pageSize } }).then(data => {
                console.log(data)
